...
- (id)initWithDelegate:(id)delegate {
    ...
    if (self) {
        ...
        [self setImage:[UIImage imageNamed:@"checkbox1_checked.png"] forState:UIControlStateNormal];
        [self setImage:[UIImage imageNamed:@"checkbox1_unchecked.png"] forState:UIControlStateSelected];
