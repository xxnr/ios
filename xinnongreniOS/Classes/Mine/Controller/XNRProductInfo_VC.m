...
//    if (self.isPhotoVC) {
//        self.tableView.frame = CGRectMake(0, 64, ScreenWidth, ScreenHeight - 64 - PX_TO_PT(80));
//        self.isPhotoVC = NO;
//    }
}
...
//    self.productView.hidden = NO;
//    [UIView animateWithDuration:0.2f animations:^{
//        self.productView.transform = CGAffineTransformMakeScale(1.3, 1.3);
//    }completion:^(BOOL finished) {
//        [UIView animateWithDuration:0.2f animations:^{
//            self.productView.transform = CGAffineTransformIdentity;
//        } completion:^(BOOL finished) {
...
//                CGRect rect = self.productView.frame;
//                //                rect.origin = CGPointMake(ScreenWidth-PX_TO_PT(50), 30);
//                rect.origin = self.shopcarButton.center;
//                self.productView.frame = rect;
//                
//            } completion:^(BOOL finished) {
//                [UIView animateWithDuration:0.2f animations:^{
