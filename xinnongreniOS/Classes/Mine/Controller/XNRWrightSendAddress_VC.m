...
@interface XNRWrightSendAddress_VC ()<UITextViewDelegate>{
...
@implementation XNRWrightSendAddress_VC
...
-(void)submitClick{
    ...
    if(self.textView.text.length==0){
        ...
        self.WrightSendAddressBlock(self.textView.text);
