...
#import "XNRRscDetialDeliverCell.h"
#import "XNRRscDeliverFrameModel.h"
#import "XNRRscOrderModel.h"
@interface XNRRscDetialDeliverCell()
...
@implementation XNRRscDetialDeliverCell
#pragma mark - 初始化
+ (instancetype)cellWithTableView:(UITableView *)tableView
{
    static NSString *ID = @"RscCell";
    XNRRscDetialDeliverCell *cell = [tableView dequeueReusableCellWithIdentifier:ID];
    if (cell == nil) {
        cell = [[XNRRscDetialDeliverCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:ID];
