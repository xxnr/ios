...
@implementation XNRRscMyOrderStateCell

#pragma mark - 初始化
+ (instancetype)cellWithTableView:(UITableView *)tableView
{
    static NSString *ID = @"RscCell";
    XNRRscMyOrderStateCell *cell = [tableView dequeueReusableCellWithIdentifier:ID];
    if (cell == nil) {
        cell = [[XNRRscMyOrderStateCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:ID];
...
//    goodsNumberLabel.backgroundColor = [UIColor redColor];
...
-(void)setFrameModel:(XNRRscSkusFrameModel *)frameModel
{
