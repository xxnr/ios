...
-(void)createUI{
    ...
    morePruductBtn.titleEdgeInsets = UIEdgeInsetsMake(0, PX_TO_PT(ScreenWidth/2)-PX_TO_PT(22), 0, 0);    [morePruductBtn addTarget:self action:@selector(moreClick) forControlEvents:UIControlEventTouchUpInside];
